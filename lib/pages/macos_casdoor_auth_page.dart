...
/// OAuth WebView for macOS, avoiding Casdoor's crashing desktop popup.
class MacosCasdoorAuthPage extends StatefulWidget {
  const MacosCasdoorAuthPage({
    super.key,
  ...
  @override
  State<MacosCasdoorAuthPage> createState() => _MacosCasdoorAuthPageState();
}

class _MacosCasdoorAuthPageState extends State<MacosCasdoorAuthPage> {
